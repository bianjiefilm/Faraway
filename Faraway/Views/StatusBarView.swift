            ...
            ScrollView(.vertical, showsIndicators: true) {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(spacing: 12) {
                        Divider().background(Color.white.opacity(0.1))
                        HStack {
                            Text("开机启动").font(.system(size: 13)).foregroundColor(.white)
                            Spacer()
                        ...
                        HStack {
                            Text("版本").font(.system(size: 13)).foregroundColor(.white)
                            Spacer()
                            Text("1.0.0").font(.system(size: 12)).foregroundColor(.white.opacity(0.4))
                        }
                    }
                }
                .padding(16)
