...
class MessageProvider: ObservableObject {
    ...
    /// Normal eye care messages
    private let normalMessages: [ReminderMessage] = [
        ReminderMessage(
            text: "看看窗外吧\n远处的风景在等你 🌿",
    ...
    /// 🌻 Special sunflower messages — hidden easter eggs
    private let specialMessages: [ReminderMessage] = [
        ReminderMessage(
            text: "太阳葵也需要\n看看远处的阳光",
            subtitle: "— 来自一个关心你的人",
            gradientColors: [
    ...
    func nextMessage() -> ReminderMessage {
        ...
        // Every ~5 reminders, show a special sunflower message
        if messageIndex % 5 == 0 {
